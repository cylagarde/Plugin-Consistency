...
/**
 * The class <b>PluginInfoDetail</b> allows to.<br>
 */
class PluginInfoDetail
{
   ...
   * @param parent
   */
  PluginInfoDetail(PluginTabItem pluginTabItem, Composite parent)
  {
  ...
  public void setPluginInfo(PluginInfo pluginInfo)
  {
    ...
    if (pluginInfo != null)
    {
      ...
      Set<Type> declaredPluginTypeFromPatternInfoSet = pluginTabItem.pluginTabFolder.pluginConsistencyPreferencePage.pluginConsistency.patternList.stream()
      ...
      Set<Type> forbiddenPluginTypeFromPatternInfoSet = pluginTabItem.pluginTabFolder.pluginConsistencyPreferencePage.pluginConsistency.patternList.stream()
        .filter(patternInfo -> patternInfo.acceptPlugin(pluginInfo.id))
